...
setup(
  name = 'nextoff',         
  packages = ['nextoff', 'nextoff.test', 'nextoff.data', 'nextoff.models'],  # Important!!
  version = '0.1.2.5',      # Always update!
  license='MIT',        
  ...
  download_url = 'https://github.com/rakesh4real/nextoff/archive/v0.1.2.5.tar.gz',  # link pasted from release
