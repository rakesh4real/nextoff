...
setup(
  name = 'nextoff',         
  packages = ['nextoff', 'nextoff.test', 'nextoff.data', 'nextoff.models'],   # Chose the same as "name"
  version = '0.1.2.4',      # Always update!
  license='MIT',        
  ...
  download_url = 'https://github.com/rakesh4real/nextoff/archive/v0.1.2.4.tar.gz',  # link pasted from release
